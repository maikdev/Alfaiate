...
function openPopup(){
	...
	$('#forgot_password, #reset_password, #success_reset, #password_sent, #error_login, #register, #banned_login, #banned_register').hide();
	$('#login').show();
	$('#play').fadeOut();
	$('#loginWrapper').fadeIn();
	$('body').css('overflow','hidden');
...
function openPopupRegister(){
	...
	$('#forgot_password, #reset_password, #success_reset, #password_sent, #error_login, #login, #banned_login, #banned_register').hide();
	$('#register').show();
	$('#play').fadeOut();
	$('#loginWrapper').fadeIn();
	$('body').css('overflow','hidden');
